...
if (window.PUBLIC_FLAG !== undefined && window.PUBLIC_FLAG) {
  ...
  if (env === 'test' || process.env.NODE_ENV === 'development') {
    misBaseUrl = 'http://gw-test.intra.xiaojukeji.com';
  } else if (env === 'pre') {
    misBaseUrl = 'https://gw-pre.am.xiaojukeji.com';
  } else {
    misBaseUrl = 'https://gw.am.xiaojukeji.com';
  }
} else {
  if (window.location.host.indexOf('daedalus.intra.xiaojukeji.com') > -1) {
    misBaseUrl = 'http://boss.xiaojukeji.com';
  } else {
    misBaseUrl = 'http://boss-test.intra.xiaojukeji.com';
  }
}
